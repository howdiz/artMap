...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gallery.gallery_hours'
        db.add_column('maps_gallery', 'gallery_hours', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gallery.gallery_hours'
        db.delete_column('maps_gallery', 'gallery_hours')
